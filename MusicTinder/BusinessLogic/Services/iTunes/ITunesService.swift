...
class ITunesService {
    ...
    private weak var searchDelegate: SearchITunesDelegate?
    private var validatedArtistName: String = ""
...
private extension ITunesService {
    ...
    func processSearchResult(_ resultData: AnyObject) -> Song {
        ...
        guard let resultsArray = resultData["results"] as? [AnyObject] else { return result }
    ...
    func song(from artistDictionary: AnyObject?) -> Song {
        var result = Song(artistName: "", collectionName: "", trackName: "", primaryGenreName: "", previewUrl: .none, artworkUrl100: .none, artistViewUrl: .none)

        guard let artistDictionary = artistDictionary else { return result }
