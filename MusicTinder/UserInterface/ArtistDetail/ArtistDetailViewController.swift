...
class ArtistDetailViewController: UIViewController {
    ...
    @IBOutlet private weak var artistBioLabel: UILabel!
    @IBOutlet private weak var scrollView: UIScrollView!
    @IBOutlet private weak var artistImageViewHeightConstraint: NSLayoutConstraint!
    @IBOutlet private weak var artistLabel: ArtistNameLabel!
    ...
    private var artistImageViewBaseHeight: CGFloat = 0.0
...
private extension ArtistDetailViewController {
    ...
    func loadArtistImage(_ artist: Artist?, completion: @escaping (_ image: UIImage) -> Void) {
