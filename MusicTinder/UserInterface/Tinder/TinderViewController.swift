...
class TinderViewController: UIViewController {
    ...
    @IBOutlet private weak var artistScrollView: UIScrollView!
    @IBOutlet private weak var greenView: UIView!
    @IBOutlet private weak var messageOverlayView: UIView!
    @IBOutlet private weak var messageOverlayLabel: UILabel!
    @IBOutlet private weak var redView: UIView!
    @IBOutlet private weak var artistLabel: UILabel!

    @IBOutlet private weak var listenButton: UIButton!
    @IBOutlet private weak var bufferingLabel: UILabel!

    @IBOutlet private weak var songInfoView: UIView!
    @IBOutlet private weak var songNameLabel: UILabel!
    @IBOutlet private weak var artistNameLabel: UILabel!
    @IBOutlet private weak var collectionImageview: UIImageView!
    @IBOutlet private weak var songInfoViewHeightConstraint: NSLayoutConstraint!

    private var artist: Artist?
    private var song: Song?
    private var greenGradientLayer = CAGradientLayer()
    private var redGradientLayer = CAGradientLayer()
    private var artistRoundedView: ArtistRoundedView?
...
extension TinderViewController: TinderView {
    ...
    func toggleListenButton(_ isPaused: Bool) {
            listenButton.backgroundColor = isPaused ? .mtGrayColor() : .mtGreenColor()
            listenButton.setTitle(isPaused ? "PAUSE" : "LISTEN", for: .normal)
    }
...
extension TinderViewController: UIScrollViewDelegate {
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        if scrollView.isDragging {
            artistRoundedView?.setImageViewAlpha(0.5)
        }
    ...
    func scrollViewDidEndDragging(_ scrollView: UIScrollView, willDecelerate decelerate: Bool) {
        artistRoundedView?.setImageViewAlpha(1.0)
    }
    ...
    func showGreenMessage(_ completion: @escaping () -> Void) {
    ...
    func showRedMessage(_ completion: @escaping () -> Void) {
